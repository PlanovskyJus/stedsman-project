...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { active: @announcement.active, body: @announcement.body, title: @announcement.title } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { active: @announcement.active, body: @announcement.body, title: @announcement.title } }
